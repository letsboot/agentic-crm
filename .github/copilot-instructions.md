...
- Access Frontend using the url from this command: `lab_url frontend 5173`
- Access Backend using the url from this command: `lab_url backend 8000`
...
- As an AI running shell commands through Cline/Shell-Tool-Usage you must run commands without blocking the terminal, therefore use this commands instead:
  ...
  - Start the frontend for the user: `open $(lab_url frontend 5173)`
  - To check if it's running use `docker compose ps` 
- Frontend runs on `localhost:5173` or `lab_url frontend 5173`
